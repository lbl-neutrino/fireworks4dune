...
#scripts/load_yaml.py specs/ND_Production_v1.yaml specs/MicroProdN3p1_NDLAr-merge2x2-test/*.genie.nu.yaml --replace
#scripts/load_yaml.py specs/ND_Production_v1.yaml specs/MicroProdN3p1_NDLAr-merge2x2-test/*.edep.nu.yaml --replace
#scripts/load_yaml.py specs/ND_Production_v1.yaml specs/MicroProdN3p1_NDLAr-merge2x2-test/*.hadd.nu.yaml --replace
#scripts/load_yaml.py specs/ND_Production_v1.yaml specs/MicroProdN3p1_NDLAr-merge2x2-test/*.spill.nu.yaml --replace
...
#scripts/fwsub.py --runner ND_Production_v1_Hadd --base-env MicroProdN3p1-merge2x2-test_NDLAr_2E18_FHC.nu.hadd --size $spill_size --start $start
...
#scripts/fwsub.py --runner ND_Production_v1_SpillBuild --base-env MicroProdN3p1-merge2x2-test_NDLAr_2E18_FHC.spill.nu --size $spill_size --start $start
