...
scripts/rescue_from_scratch.simple.py --srcdir /pscratch/sd/d/dunepro/mkramer/output/Reflow_FSD_v7/flow --destdir /global/cfs/cdirs/dunepro/www/data/nd-production/FSD_run1/reflows/v7/flow
