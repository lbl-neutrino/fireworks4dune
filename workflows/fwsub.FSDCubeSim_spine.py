...
def main():
    ...
    ap.add_argument('--base-env-prefix', default='FSDCubeSim_v1')
    ap.add_argument('--name', help='Defaults to --base-env-prefix')
    ap.add_argument('--repo', default='SimForFSD_v1')
    ap.add_argument('--size', type=int, default=256, help='Number of final outputs (post-hadd etc.) to produce')
